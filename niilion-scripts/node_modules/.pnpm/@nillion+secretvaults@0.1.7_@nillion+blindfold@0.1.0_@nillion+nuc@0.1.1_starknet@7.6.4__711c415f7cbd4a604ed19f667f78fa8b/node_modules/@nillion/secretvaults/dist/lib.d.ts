 ...
 * ```
 */
declare const Did: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "Did">;
...
declare const RegisterBuilderRequest: z.ZodObject<{
    did: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "Did">;
    name: z.ZodString;
}, z.core.$strip>;
...
declare const ReadBuilderProfileResponse: z.ZodObject<{
    data: z.ZodObject<{
        _id: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "Did">;
...
declare const Acl: z.ZodObject<{
    grantee: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "Did">;
    read: z.ZodBoolean;
    write: z.ZodBoolean;
...
declare const CreateOwnedDataRequest: z.ZodObject<{
    owner: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "Did">;
    collection: z.ZodUUID;
...
declare const ReadDataResponse: z.ZodObject<{
    data: z.ZodObject<{
        ...
        _created: z.ZodISODateTime;
        _updated: z.ZodISODateTime;
        _owner: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "Did">;
...
declare const ListDataReferencesResponse: z.ZodObject<{
    data: z.ZodArray<z.ZodObject<{
        builder: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "Did">;
        collection: z.ZodUUID;
        document: z.ZodUUID;
    }, z.core.$strip>>;
}, z.core.$strip>;
